          ...
          <TabsContent value="themes">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose a theme for your store. The selected theme will be applied to your storefront.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ThemeSelector />
          ...
          <TabsContent value="customize">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create a custom theme by selecting colors for your store. These settings will override the default
                  theme colors.
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  In the meantime, you can select from our pre-designed themes in the Themes tab.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
