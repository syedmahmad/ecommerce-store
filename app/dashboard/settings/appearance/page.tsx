...
export default function AppearancePage() {
  const { currentTheme, saveCustomTheme, previewTheme, setPreviewTheme } = useAdminTheme()
  ...
  const [previewMode, setPreviewMode] = useState<"admin" | "store" | null>(null)

  // Reset custom theme when current theme changes
  useEffect(() => {
    setCustomTheme({ ...currentTheme })
    setThemeName(currentTheme.isCustom ? currentTheme.name : `Custom ${currentTheme.name}`)
  }, [currentTheme])
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Customize your admin panel and store appearance</p>
          </div>
              ...
              <TabsContent value="themes">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Choose a theme for your admin panel. The selected theme will be applied to your dashboard.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <AdminThemeSelector />
                  ...
                  <div className="lg:col-span-3 space-y-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Personalize the colors of your admin panel. These settings will override the default theme
                          colors.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-6">
                          ...
                          <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <ColorPicker
                              ...
                              onChange={(color) => updateThemeColor("headerColor", color)}
                            />

                            <ColorPicker
                              label="Sidebar Color"
                              color={customTheme.sidebarColor}
                              onChange={(color) => updateThemeColor("sidebarColor", color)}
                            />

                            <ColorPicker
                              label="Accent Color"
                              color={customTheme.accentColor}
                              onChange={(color) => updateThemeColor("accentColor", color)}
                            />
                  ...
                  <div className="lg:col-span-2">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>See how your theme will look on your admin panel.</CardDescription>
                      </CardHeader>
                      <CardContent>
                        ...
                        <div className="mt-6 text-center">
                          <p className="text-sm text-muted-foreground mb-3">
                            This is a preview of how your admin theme will look. Click "Preview Theme" to see it applied
                            to your admin panel.
                          </p>
                        </div>
                      </CardContent>
          ...
          <TabsContent value="store">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your store's appearance. These settings affect how your customers see your store.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-6 lg:grid-cols-5">
                  <div className="lg:col-span-3">
                    <div className="space-y-4">
                      <p>You can customize your store's appearance from the Theme section in the dashboard.</p>
