      ...
      <div className="bg-white text-gray-800 min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="/services"
                className="inline-block bg-white text-blue-600 border border-blue-600 px-8 py-3 rounded-lg font-semibold shadow-sm hover:shadow-md transition"
              >
        ...
        <section className="max-w-7xl mx-auto px-4 py-20">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-10 text-center text-white"
          >
