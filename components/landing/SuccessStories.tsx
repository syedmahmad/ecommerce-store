...
import { Shirt, Cpu, Home } from "lucide-react";
...
//   return (
//     <div
//       className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 hover-lift animate-fade-up"
    ...
    >
      <div className="flex items-center mb-6">
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center mr-4">
          <AvatarIcon className="text-white w-6 h-6" />
        </div>
        <div>
          <h4 className="font-bold text-gray-900">{name}</h4>
          <p className="text-sm text-gray-600">{title}</p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Success Stories from Real{" "}
            <span className="gradient-text">Customers</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how businesses like yours have transformed their online presence
            and achieved remarkable growth with ZyloSpace.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-white text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
            Start your success story today. Launch your online store and join
            thousands of entrepreneurs who chose ZyloSpace.
          </p>
          <button
            className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            onClick={() => {
